  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md bg-white/60 dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl shadow-cyan-500/10">
        <h1 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-2">E-DRONE</h1>
        <p className="text-center text-gray-600 dark:text-gray-400 mb-8">O primeiro serviço de delivery por drones do Brasil!</p>
        ...
        <p className="mt-8 text-center text-gray-600 dark:text-gray-400">
          Não tem uma conta?{' '}
          <button onClick={onNavigateToSignup} className="font-semibold text-cyan-500 hover:text-cyan-400 dark:text-cyan-400 dark:hover:text-cyan-300 transition-colors">
            Cadastre-se
          </button>
        </p>
      </div>
